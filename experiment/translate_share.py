...
question.to_csv('../data/question_tran_fr.csv.gz', index=False, compression='gzip')
answer.to_csv('../data/answer_tran_fr.csv.gz', index=False, compression='gzip')